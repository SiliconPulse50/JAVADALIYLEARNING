...
因为**只会用框架的人，和懂底层的人，遇到问题时的反应完全不同**。
...
> **底层原理让你“知其所以然”，上层框架让你“高效干活”。两者不是二选一，而是“懂原理的人用框架，用得比别人深”。**

---

## 八、你接下来可以做的

你已经打通了“原理 ↔ 框架”这条线。接下来有两个方向：

1. **继续深入底层**：学类加载器、JVM 内存、并发编程（我之前给你的路线图）
2. **用原理解决实际问题**：在苍穹外卖项目里，遇到任何 `@Transactional`、`@Cacheable` 失效的情况，用你学过的原理去分析
